...
@dataclass
class AmazonLunaUbisoftPlus(AmazonLunaGameSource):
    def __init__(self) -> None:
        super().__init__()
        self.page_id = "B08LYSYW3H"
    ...
    def load_games(self) -> None:
        ...
        if not json_response:
            print("Error getting Amazon Luna Ubisoft+ games...")
            raise ValueError
                    ...
                    if game_widget["type"] == "GAME_TILE":
                        ...
                        self.games.append(
                            Game(
                                ...
                                sub_title=None,
                                platform=GamePlatform.AMAZON_LUNA_UBISOFT_PLUS,
                                source_url=self.url,
                                developer=None,
